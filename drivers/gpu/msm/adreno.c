...
void adreno_efuse_speed_bin_array(struct adreno_device *adreno_dev)
{
	...
	while (i < count) {
		...
		//pr_info("[longnt] adreno_efuse_speed_bin_array: GPU speed_bin:%d \n", adreno_dev->speed_bin);
...
static int adreno_probe(struct platform_device *pdev)
{
	...
	//pr_info("[longnt] adreno_probe: GPU speed_bin:%d \n", adreno_dev->speed_bin);
	
	adreno_update_soc_hw_revision_quirks(adreno_dev, pdev);

	//pr_info("[longnt] adreno_update_soc_hw_revision_quirks: GPU speed_bin:%d\n", adreno_dev->speed_bin);
